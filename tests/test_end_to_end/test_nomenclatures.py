...
def test_cities_nomenclatures_errors_if_no_params():
    ...
    with pytest.raises(ValueError):
        hub.get_raw_cities_nomenclatures()


def test_cities_nomenclatures_returns_empty_response():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_cities_nomenclatures(search="UNKNOWN")
...
def test_cities_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_cities_nomenclatures(county_id=1, city_id=1)
...
def test_counties_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_counties_nomenclatures()
...
def test_domains_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_domains_nomenclatures()
...
def test_regions_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_regions_nomenclatures()
...
def test_federations_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_federations_nomenclatures()
...
def test_coalitions_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_coalitions_nomenclatures()
...
def test_faculties_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_faculties_nomenclatures()
...
def test_skills_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_skills_nomenclatures()
...
def test_practice_domains_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_practice_domains_nomenclatures()
...
def test_service_domains_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_service_domains_nomenclatures()
...
def test_beneficiaries_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_beneficiaries_nomenclatures()
...
def test_issuers_nomenclatures_schema():
    hub = NGOHub(pytest.ngohub_api_url)
    response = hub.get_raw_issuers_nomenclatures()
